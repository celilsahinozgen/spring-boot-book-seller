...
public class InternalApiAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
        return !request.getRequestURI().startsWith("/api/internak");
    }
            ...
            throws ServletException, IOException
    {
            try {
                ...
                {
                    log.warn("Internal key endpoint requested without/wrog key uri: {}", request.getRequestURI());
            ...
            {
                log.error("Could not set user authenticationn in securty context",ex);
            }
